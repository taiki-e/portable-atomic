...
impl AtomicBool {
    ...
    pub fn compare_exchange(
        ...
        // TODO: this is also good for {arm,riscv} with assume-single-core?
        ...
        cfg_no_emulate_bool_cas! {
            // TODO: this is also good for s390x/armv5te-linux/powerpc64le?
            cfg_emulate_bool_weak_cas! {
                // On architectures with 8-bit CAS instruction without setting flags,
                // convert bool first to avoid extra cmp.
                let old = match self
                    .as_atomic_u8()
