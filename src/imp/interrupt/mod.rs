...
[^avr1]: https://github.com/llvm/llvm-project/blob/llvmorg-19.1.0-rc4/llvm/lib/Target/AVR/AVRExpandPseudoInsts.cpp#L1074
[^avr2]: https://github.com/llvm/llvm-project/blob/llvmorg-19.1.0-rc4/llvm/test/CodeGen/AVR/atomics/load16.ll#L5
*/
