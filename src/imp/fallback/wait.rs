...
cfg_sel!({
    ...
    //
    // Miri support is incomplete since these are not yet used in std.
    ...
    //
    // UWP doesn't support GetModuleHandleA.
    #[cfg(all(windows, not(any(target_vendor = "uwp", target_abi = "uwp"))))]
    {
        ...
        mod ffi {
            ...
            // Miri doesn't support GetModuleHandleA.
            // #[cfg(all(
            //     target_env = "msvc",
            ...
            #[cfg(miri)]
            sys_fn!({
                // Added in Windows 8 / Server 2012.
                extern "system" {
            ...
            #[cfg(not(miri))]
            sys_fn!({
                // Added in Windows XP / Server 2003.
                extern "system" {
