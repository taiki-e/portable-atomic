...
mod os {
    ...
    mod ffi {
        ...
        #[cfg(any(test, not(all(target_env = "msvc", not(target_vendor = "win7")))))]
        sys_type!({
        ...
        #[cfg(all(target_env = "msvc", not(target_vendor = "win7")))]
        sys_fn!({
            extern "system" {
        ...
        #[cfg(not(all(target_env = "msvc", not(target_vendor = "win7"))))]
        dlsym!(
...
#[cfg(not(any(
    target_os = "freebsd",
    all(windows, target_env = "msvc", not(target_vendor = "win7"))
)))]
#[allow(dead_code)]
mod no_futex {
