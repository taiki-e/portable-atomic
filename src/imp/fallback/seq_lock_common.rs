...
use crate::imp::fallback::{WRITE_LOCK_ACQUIRE_ORDER, WRITE_LOCK_RELEASE_ORDER};
...
// pub(crate) for tests.
pub(crate) const CONTENDED: State = 0b11; // locked, and other threads waiting (contended)
