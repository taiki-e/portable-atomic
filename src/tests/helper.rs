...
macro_rules! __test_atomic_common {
    ($atomic_type:ty, $value_type:ty) => {
        ...
        #[test]
        fn alignment() {
            // https://github.com/rust-lang/rust/blob/1.67.0/library/core/tests/atomic.rs#L250
...
macro_rules! __test_atomic_ptr_pub {
    ($atomic_type:ty) => {
        ...
        // https://github.com/rust-lang/rust/blob/1.67.0/library/core/tests/atomic.rs#L130-L213
        #[test]
        fn ptr_add_null() {
