...
asm_test::compare_exchange::bool::acqrel_seqcst:
        ...
        ret
0:
        amoor.b.aqrl      a2, zero, (a0)
        xor               a0, a1, a2
        mv                a1, a2
        ret
1:
        amoswap.b.aqrl    a2, zero, (a0)
        xor               a0, a1, a2
        mv                a1, a2
        ret
...
asm_test::compare_exchange::bool::acquire_acquire:
        ...
        ret
0:
        amoor.b.aq        a2, zero, (a0)
        xor               a0, a1, a2
        mv                a1, a2
        ret
1:
        amoswap.b.aq      a2, zero, (a0)
        xor               a0, a1, a2
        mv                a1, a2
        ret
...
asm_test::compare_exchange::bool::release_relaxed:
        ...
        ret
0:
        amoor.b.rl        a2, zero, (a0)
        xor               a0, a1, a2
        mv                a1, a2
        ret
1:
        amoswap.b.rl      a2, zero, (a0)
        xor               a0, a1, a2
        mv                a1, a2
        ret

asm_test::compare_exchange::bool::acqrel_seqcst_true_true:
        amoor.b.aqrl      a1, zero, (a0)
        xori              a0, a1, 0x1
        ret
...
asm_test::or::u8::acqrel_zero:
        amoor.b.aqrl      zero, zero, (a0)
        ret

asm_test::or::u8::acquire_all:
        li                a1, -0x1
        amoswap.b.aq      zero, a1, (a0)
        ret

asm_test::or::u8::relaxed_all:
        li                a1, -0x1
        amoswap.b         zero, a1, (a0)
        ret

asm_test::or::u8::release_all:
        li                a1, -0x1
        amoswap.b.rl      zero, a1, (a0)
        ret
...
asm_test::or::u8::acquire_zero:
        amoor.b.aq        zero, zero, (a0)
        ret

asm_test::or::u8::relaxed_zero:
        amoor.b           zero, zero, (a0)
        ret

asm_test::or::u8::release_zero:
        amoor.b.rl        zero, zero, (a0)
        ret
...
asm_test::or::u16::acqrel_zero:
        amoor.h.aqrl      zero, zero, (a0)
        ret

asm_test::or::u16::acquire_all:
        li                a1, -0x1
        amoswap.h.aq      zero, a1, (a0)
        ret

asm_test::or::u16::relaxed_all:
        li                a1, -0x1
        amoswap.h         zero, a1, (a0)
        ret

asm_test::or::u16::release_all:
        li                a1, -0x1
        amoswap.h.rl      zero, a1, (a0)
        ret
...
asm_test::or::u16::acquire_zero:
        amoor.h.aq        zero, zero, (a0)
        ret

asm_test::or::u16::relaxed_zero:
        amoor.h           zero, zero, (a0)
        ret

asm_test::or::u16::release_zero:
        amoor.h.rl        zero, zero, (a0)
        ret
...
asm_test::or::u64::acqrel_zero:
        amoor.d.aqrl      zero, zero, (a0)
        ret

asm_test::or::u64::acquire_all:
        li                a1, -0x1
        amoswap.d.aq      zero, a1, (a0)
        ret

asm_test::or::u64::relaxed_all:
        li                a1, -0x1
        amoswap.d         zero, a1, (a0)
        ret

asm_test::or::u64::release_all:
        li                a1, -0x1
        amoswap.d.rl      zero, a1, (a0)
        ret
...
asm_test::or::u64::acquire_zero:
        amoor.d.aq        zero, zero, (a0)
        ret

asm_test::or::u64::relaxed_zero:
        amoor.d           zero, zero, (a0)
        ret

asm_test::or::u64::release_zero:
        amoor.d.rl        zero, zero, (a0)
        ret
...
asm_test::and::u8::acquire_zero:
        amoswap.b.aq      zero, zero, (a0)
        ret

asm_test::and::u8::relaxed_zero:
        amoswap.b         zero, zero, (a0)
        ret

asm_test::and::u8::release_zero:
        amoswap.b.rl      zero, zero, (a0)
        ret
...
asm_test::and::u16::acquire_zero:
        amoswap.h.aq      zero, zero, (a0)
        ret

asm_test::and::u16::relaxed_zero:
        amoswap.h         zero, zero, (a0)
        ret

asm_test::and::u16::release_zero:
        amoswap.h.rl      zero, zero, (a0)
        ret
...
asm_test::swap::bool::acquire_false:
        amoswap.b.aq      a0, zero, (a0)
        zext.b            a0, a0
        ret

asm_test::swap::bool::relaxed_false:
        amoswap.b         a0, zero, (a0)
        zext.b            a0, a0
        ret

asm_test::swap::bool::release_false:
        amoswap.b.rl      a0, zero, (a0)
        zext.b            a0, a0
        ret
