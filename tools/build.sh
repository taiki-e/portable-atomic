...
if [[ "${rustc_version}" == *"nightly"* ]] || [[ "${rustc_version}" == *"dev"* ]]; then
    ...
    case "${rustc_version}" in
        ...
        *)
            ...
            check_cfg="-Z unstable-options --check-cfg=names(docsrs,portable_atomic_unsafe_assume_single_core,portable_atomic_unsafe_libcalls,$(IFS=',' && echo "${build_script_cfg[*]}"))"
