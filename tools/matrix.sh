...
for target in "${targets[@]}"; do
  ...
  case "${target}" in
    ...
    mips* | powerpc-* | sparc* | armv7-unknown-linux-gnueabihf | armeb-unknown-linux-gnueabi | thumbv7neon-unknown-linux-gnueabihf | arm-linux-androideabi) test_only_on_nightly=1 ;;
