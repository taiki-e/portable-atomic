...
for target in "${targets[@]}"; do
  ...
  case "${target}" in
    ...
    loongarch* | mips* | powerpc-* | sparc* | arm-unknown-linux-gnueabi | armv7-unknown-linux-gnueabi | armeb-unknown-linux-gnueabi | arm-linux-androideabi) test_only_on_nightly=1 ;;
    ...
    x86_64-apple-darwin | i586-unknown-linux-gnu | i686-pc-windows-msvc | aarch64-apple-ios-macabi | aarch64-pc-windows-msvc | aarch64-pc-windows-gnullvm) test_only_on_nightly=1 ;;
  esac
